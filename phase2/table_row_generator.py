...
for z in range(1000000):
    ...
    f_casting.write(str(mid_casting[z])+','+str(aid_casting[4*z])+'\n')
    f_casting.write(str(mid_casting[z])+','+str(aid_casting[(4*z) + 1])+'\n')
    f_casting.write(str(mid_casting[z])+','+str(aid_casting[(4*z) + 2])+'\n')
    f_casting.write(str(mid_casting[z])+','+str(aid_casting[(4*z) + 3])+'\n')
